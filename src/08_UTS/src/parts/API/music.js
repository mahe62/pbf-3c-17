...
class Music extends Component {
    ...
    componentDidMount() {
        fetch("https://my-json-server.typicode.com/mahe62/mahe62.github.io/music")
    ...
    render() {
        ...
        if (error) {
            ...
            return (
                <div>
                    {
                        dataArtikel.map(music => {
                            return <DaftarArtikel title={music.title} kategori={music.kategori} pic={music.img} />
                        })
                    }
                </div>
            );
